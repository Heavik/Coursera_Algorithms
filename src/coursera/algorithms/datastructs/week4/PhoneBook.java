...
public class PhoneBook {
    ...
    private Contact[] contactsArray = new Contact[ARRAY_LENGTH];
    ...
    private Contact find(Query query) {
        return contactsArray[query.number];
    }

    private void addOrUpdate(Query query) {
        contactsArray[query.number] = new Contact((query.name), query.number);
    }
    ...
    private void processQuery(Query query) {
        if (query.type.equals("add")) {
            ...
            String response = "not found";
            Contact foundContact = find(query);
            if (foundContact != null) {
                response = foundContact.name;
            }
            writeResponse(response);
        }
    }
