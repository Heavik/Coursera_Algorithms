 ...
 * Description: The goal in this problem is to count the number of inversions of a given sequence.
 *
 * Input: The first line contains an integer 𝑛, the next one contains a sequence of integers 𝑎0, 𝑎1,...,𝑎[𝑛−1].
 *
